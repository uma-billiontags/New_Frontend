...
import {
  ...
  Bell, CheckCircle2, AlertTriangle, ClipboardList,
  type LucideIcon, 
} from 'lucide-react';
...
const NAV: NavGroup[] = [
  {
    ...
    items: [
      { label: "Dashboard", icon: LayoutDashboard, to: "/campaign_team/overview" },
    ],
  },
   {
    section: "Campaigns",
    items: [
      { label: "Campaigns", icon: ClipboardList, to: "/campaign_team/campaigns" },
    ],
  },
 {
    section: "STATUS",
    items: [
        { label: "Completed Tasks", icon: CheckCircle2, to: "/campaign_team/status/completed" },
        { label: "Incompleted Tasks", icon: AlertTriangle, to: "/campaign_team/status/incompleted" },
    ],
},
];
...
interface CampaignTeamSidebarProps {
...
export default function CampaignTeam_Sidebar({
  notifications,
  unreadCount,
  showDropdown,
  onToggleDropdown,
  ...
  return (
    <aside className="db-sidebar">
      ...
      <div className="db-logo" style={{ position: "relative" }}>
        ...
        <div className="db-logo-sub">Campaign Team Portal</div>
      </div>
          ...
          <div key={gi}>
            ...
            {group.items.map((item) => {
              const active =
                ...
                (item.to !== "/campaign_team/overview" &&
      ...
      <div className="db-sidebar-footer">
        <div className="db-sidebar-user">
          ...
          <div>
            <div className="db-sidebar-uname">Campaign Team</div>
