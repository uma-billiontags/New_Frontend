        ...
        return (
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{
              ...
              <FileImageOutlined style={{ fontSize: 14, color: 'var(--blue)' }} />
            </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div>
          <h1 style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-primary)' }}>Image Creatives</h1>
          <p style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 1, letterSpacing: '0.04em', fontWeight: 500 }}>ALL IMAGE CREATIVES ACROSS CAMPAIGNS</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 20 }}>
        {[
          { label: 'Total Image Creatives', value: rows.length, color: 'var(--blue)', bg: 'var(--blue-bg)', border: 'var(--blue)' },
          ...
          { label: 'Valid HTML Tags', value: withHtmlTag, color: 'var(--amber)', bg: 'var(--amber-bg)', border: 'var(--amber)' },
        ].map(s => (
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 12, fontSize: 11.5, color: 'var(--text-secondary)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginLeft: 8 }}>
          <FileImageOutlined style={{ fontSize: 11, color: 'var(--blue)' }} />
          ...
          locale={{
            emptyText: (
              <div style={{ padding: '48px 0', textAlign: 'center', color: 'var(--text-secondary)' }}>
                <FileImageOutlined style={{ fontSize: 36, marginBottom: 12, color: 'var(--border-strong)' }} />
                <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-primary)' }}>No image creatives found</div>
