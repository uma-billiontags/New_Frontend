...
interface CreativeTeamSidebarProps {
...
export default function CreativeTeam_Sidebar({
  notifications,
  unreadCount,
  showDropdown,
  onToggleDropdown,
  ...
  return (
    <aside className="db-sidebar">
      ...
      <div className="db-logo" style={{ position: "relative" }}>
        ...
        <div className="db-logo-sub">Creative Team Portal</div>
      </div>
          ...
          <div key={gi}>
            ...
            {group.items.map((item) => {
              const active =
                ...
                (item.to !== "/creative_team/overview" &&
      ...
      <div className="db-sidebar-footer">
        <div className="db-sidebar-user">
          ...
          <div>
            <div className="db-sidebar-uname">Creative Team</div>
